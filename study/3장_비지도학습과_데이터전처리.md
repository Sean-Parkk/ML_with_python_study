...
- 피처들이 통계적으로 상관관계가 없도록 데이터셋을 회전시키는 기술
    - 회전 뒤 데이터를 설명에 있어 중요도에 따라 종종 새로운 특성 중 일부만 선택
        ...
        ![study/3/Untitled.png](study/3/Untitled.png)
...
- 주성분 시각화
    ...
    ![study/3/Untitled%201.png](study/3/Untitled%201.png)
...
```
    ...
    - PCA의 화이트닝 옵션
        ...
        (변환한 후 StandardScaler를 적용하는 것과 같음)
            ...
            ![study/3/Untitled%202.png](study/3/Untitled%202.png)

        - 사람이 이해하는것과 알고리즘이 데이터를 해석하는 방식은 상당히 다르다.
        - 특히 이미지와 같은 경우엔 더더욱!
        - 주성분을 이해하기 위해, 몇 개의 주성분을 사용해 원본 데이터를 재구성해보기(무서어)

            ![study/3/Untitled%203.png](study/3/Untitled%203.png)
...
- NMF에서는 음수가 아닌 성분과 계수 값을 찾음
    ...
    ![study/3/Untitled%204.png](study/3/Untitled%204.png)
...
4. 2~3 반복 후 클러스터에 할당되는 데이터 포인트에 변화 없을 시 종료
    ...
    ![study/3/Untitled%205.png](study/3/Untitled%205.png)

    - 새로운 데이터 포인트가 주어지면, 가장 가까운 클러스터 중심을 할당

        ![study/3/Untitled%206.png](study/3/Untitled%206.png)
```python
...
- k-평균 알고리즘이 실패하는 경우
    ...
    - 그 중심 사이의 정확히 중간에 경계 그림
        ...
        ![study/3/Untitled%207.png](study/3/Untitled%207.png)

        - 클러스터 0, 1을 보면 중심에서 조금 떨어진 데이터도 포함함

        ![study/3/Untitled%208.png](study/3/Untitled%208.png)

        - 원형이 아닌 데이터셋에선 잘못 구분할 수 있음
            - 모든 방향을 중요시함

        ![study/3/Untitled%209.png](study/3/Untitled%209.png)
...
- 벡터 양자화(vector quantization)
    ...
    - k-means: 클러스터 중심, 즉 데이터들을 하나의 성분으로 표현
        ...
        ![study/3/Untitled%2010.png](study/3/Untitled%2010.png)
...
![study/3/Untitled%2011.png](study/3/Untitled%2011.png)
...
- 병합 군집은 **계층적 군집**을 만듦(hierarchical clustering)
    ...
    ![study/3/Untitled%2012.png](study/3/Untitled%2012.png)

- **덴드로그램**(dendrogram)
    - 다차원의 계층 군집을 시각화

    ![study/3/Untitled%2013.png](study/3/Untitled%2013.png)
...
![study/3/Untitled%2014.png](study/3/Untitled%2014.png)
