...
```
    ...
    - PCA의 화이트닝 옵션
        ...
        (변환한 후 StandardScaler를 적용하는 것과 같음)
            ...
            ![images/3/Untitled%202.png](images/3/Untitled%202.png)

        - 사람이 이해하는것과 알고리즘이 데이터를 해석하는 방식은 상당히 다르다.
        - 특히 이미지와 같은 경우엔 더더욱!
        - 주성분을 이해하기 위해, 몇 개의 주성분을 사용해 원본 데이터를 재구성해보기(무서어)

            ![images/3/Untitled%203.png](images/3/Untitled%203.png)
...
4. 2~3 반복 후 클러스터에 할당되는 데이터 포인트에 변화 없을 시 종료
    ...
    ![images/3/Untitled%205.png](images/3/Untitled%205.png)
...
- 병합 군집은 **계층적 군집**을 만듦(hierarchical clustering)
    ...
    ![images/3/Untitled%2012.png](images/3/Untitled%2012.png)

- **덴드로그램**(dendrogram)
    - 다차원의 계층 군집을 시각화

    ![images/3/Untitled%2013.png](images/3/Untitled%2013.png)
...
![images/3/Untitled%2014.png](images/3/Untitled%2014.png)
